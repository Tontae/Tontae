...
- 🛠️ Currently mastering: **Backend Systems, Modern Web Dev (React, Next.js, Tailwind), and Full-stack Game Architecture.**
- 🎨 Background in: **Computer Graphics & Video Production.**

---

### 🌱 Current R&D / Work in Progress
Always exploring new horizons to push the boundaries of my technical skills:
...
| :--- | :--- | :--- |
| **Roblox Experience** | Luau Scripting & System | [Play on Roblox 🚀](https://www.roblox.com/share?code=b3f75a4f6a8e6b479c54e349a3255b50&type=ExperienceDetails&stamp=1777612952279) |
...
<details>
  <summary><b>🔥 Click to see my Roblox Full-Stack capabilities</b></summary>
  <br/>
  <ul>
    <li><b>Advanced Luau Scripting:</b> Modular coding, Client-Server networking, and complex game loops.</li>
    <li><b>UI & Interactions:</b> Advanced GUI, <b>UI-to-Part rendering</b>, and responsive design.</li>
    <li><b>Visuals & Lighting:</b> Custom materials, VFX, and atmospheric lighting configurations.</li>
    <li><b>Backend Systems:</b> Secure DataStore management and core game architectures.</li>
  </ul>
</details>
